...
Date: 2026-09-26. Code: `7b454ef` on GitHub `main`.
...
resource references, controlled Position behavior, normal multi-Cue
structure, and one independently confirmed exact-content motif. This does
