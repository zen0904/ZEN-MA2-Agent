...
2. `cue_semantics` — per-Cue observable layers (`RAW_VALUE`,
   ...
   strings, resource identities, complete observed PAN/TILT behaviors, Effect
   identity and target observations, a broad structural fingerprint, and a
   strict stored-content fingerprint.
