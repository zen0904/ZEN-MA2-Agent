...
class AgentRuntime:
    ...
    def read_state(self, command: str) -> str:
        ...
        if not re.fullmatch(r'List (?:Group|Fixture|Layout|Sequence|Cue|Effect|Page|Executor|Preset)(?: (?:\d+|Dimmer|Position|Gobo|Color|Beam|Focus|Control|All))?', command, re.I):
