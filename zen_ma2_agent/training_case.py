...
def build_training_case_001(profile: dict[str, Any], *, show_profile_ref: str = "data/ZEN_CURRENT_SHOW_PROFILE.json") -> dict[str, Any]:
    ...
    case = {
        ...
        "design_principles": [
            {"principle": "RESERVE_HEADROOM", "why": "A look needs room to grow later.", "when_useful": "Openings, verses, and any long-form build.", "when_not_applicable": "A deliberately maximal one-shot cue.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "SECTION_CONTRAST", "why": "Section changes should be legible as changes in visual structure, not only level.", "when_useful": "Verse/chorus and pre/final transitions.", "when_not_applicable": "A deliberately static ambient passage.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "REPEATED_SECTION_DEVELOPMENT", "why": "Later occurrences should have a reason to feel related but not copied.", "when_useful": "Repeated verses, choruses, or hooks.", "when_not_applicable": "A conscious exact reprise.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "EFFECT_FATIGUE_AVOIDANCE", "why": "A motion effect loses impact when it is always present.", "when_useful": "Chorus/impact planning.", "when_not_applicable": "A continuous texture brief that explicitly demands it.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "LAYER_ESCALATION", "why": "Energy can rise through coverage, contrast, motion, focus, or added layers.", "when_useful": "Builds and finales.", "when_not_applicable": "When resources or song structure require restraint.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "FOCUS_HIERARCHY", "why": "The audience needs a readable subject even in a rich rig.", "when_useful": "Solos, verses, and dense choruses.", "when_not_applicable": "An intentionally environmental interlude.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "RESOURCE_AWARENESS", "why": "The same intent must degrade gracefully on limited or asymmetric rigs.", "when_useful": "Every design decision.", "when_not_applicable": "Never; the implementation may vary.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
            {"principle": "ASYMMETRY_TOLERANCE", "why": "A designer should work with imperfect rigs instead of inventing symmetry.", "when_useful": "Medium, small, and production shows.", "when_not_applicable": "Only when symmetry is actually evidenced.", "scope": "GENERALIZABLE_LESSON", "provenance": "CURRENT_INTERNAL_GENERAL_PRINCIPLE"},
        ],
        "constraints": {
            "read_only": True,
        ...
        "anti_patterns": [
            {"id": "INTENSITY_ONLY_PROGRESSION", "description": "Raising Dimmer while keeping every other layer identical.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "SAME_GROUP_EVERY_CUE", "description": "Using one Group for all sections despite available alternatives.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "SAME_PRESET_EVERY_CUE", "description": "Missing palette/focus development when verified resources exist.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "EFFECT_FATIGUE", "description": "Repeating one Effect until it no longer marks a meaningful section.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "EFFECT_TOO_EARLY", "description": "Spending a signature motion resource before the first major opening.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "FINAL_EQUALS_ONE_HUNDRED", "description": "Treating Final Chorus escalation as Dimmer 100% only.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
            {"id": "GEOMETRY_IGNORED", "description": "Failing to use verified numeric geometry when it is available.", "evidence": "Current V1 creative review", "scope": "GENERALIZABLE_LESSON", "provenance": "INTERNAL_CASE_EVIDENCE"},
        ],
        "future_cases": [
